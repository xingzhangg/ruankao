...
![会员应用 DFD 的三处画错：3.1.2 没有输出、3.1.3 没有输入、3.1.1 账目数据无来源](../外部资源/转录md/images/fig_d13_s011.png)
...
![状态转换图 STD 示例：注册 → 学习 → 测试](../外部资源/转录md/images/fig_d11_s038.png)
...
![分层数据流图：（a）顶层图（b）0 层图（c）加工 1 的 1 层图（d）加工 2 的 1 层图](../外部资源/转录md/images/fig_d13_s012.png)
